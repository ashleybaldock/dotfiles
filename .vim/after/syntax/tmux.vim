...
for s:i in range(0, 255)
    let s:bg = (!s:i || s:i == 16 || (s:i > 231 && s:i < 235)) ? 15 : "#ffffff"
    exec "syn match tmuxColour" .. s:i
          \ "/\\<colou\\?r" .. s:i .. "\\>/ display contained containedin=tmuxColour"
          \ " | hi " "tmuxColour" .. s:i 
          \ "guifg=" .. get(s:tmux_colours, s:i)
