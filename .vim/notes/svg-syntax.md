...
```pre
 ╭─────────────┬────────────────────────┬──────────────────────────────╮
 │             │       ʹˈˊˉˋ˴˵ˎˍˏ˶ˌˈ️ˊ️ˉ️ˋ️ˎ️ˍ️ˏ️ˌ️ :˸ ːː️ˑˑ️ ˂˄˅˃ /ʹ️/ʺ          │
 │             │       ˓️˒️˓︎˒ʿʾʿ️︎ʾ️ ˟˔˕˖˗️˖️︎˗︎  ˷˾˽ꜚ˹˺˻˼ ˱˰˯˲  /ʹ️/ʺ           │
 │             │ ˣ͓̽ ˖˷   ʋ ⱽᶺᵛʌvᵥ ᴰᵈʍʷʍʸyʎʏ ʱᶹ                          │
 │             │    ᠓ ᠀᠁   ˖̠˰̝ ˯˕̬                                       │
 │             │             ᴹᴸᴴⱽ ᵀ  ᴬ                  ᵐˡʰᵛᵍᵗᶜˢᵃ ᶻ    │
 │             │             ᴹ️ᴸ️ᴴ️ⱽ️ꞯᵀ️ᴄ ᴬ️                  ᵐ️ˡ️ʰ️ᵛ️ᵍ️ᵗ️ᶜ️ˢ️ᵃ️ ᶻ️    │
 ├─────────────┼────────────────────────┼──────────────────────────────┤
 │    viewBox: │        𝝼ˣ️ 𝝼ʸ️ 𝝼ʷ️ 𝝼ʰ️     │                              │
 │             │  Absolute  [MLHVQTCSA] │    Relative  [mlhvqtcsa]     │
 ├─────────────┼────────────────────────┼──────────────────────────────┤
 ...
 ├─────────────┼────────────────────────┼──────────────────────────────┤
 │  Quadratic: │ Q  x¹ y¹ x  y          │ q  ᵈx¹ ᵈy¹ ᵈx ᵈy             │
 │             │   ╰╴p¹╶╯╰╴pᵉ️╶╯         │                              │
 │             │                        │                              │
 │             │                        │                              │
 │             │ T    →️   x  y          │ t     →️    ᵈx ᵈy             │
 │             │                        │                              │
 │      Cubic: │ C  x¹ y¹ x² y² x  y    │ c  ᵈx¹ ᵈy¹ ᵈx² ᵈy² ᵈx ᵈy     │
 │             │                        │                              │
...
𝝙x = 𝖵ᵪᵥₓ ᘁᘁ xᵥ yᵥ wᵥ hᵥ ᕽ ᴴᵂ ᶹᑋ
