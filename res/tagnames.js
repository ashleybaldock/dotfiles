...
'animation', 'audio', 'canvas', 'circle', 'clipPath',
...
'glyphRef', 'handler', 'hkern', 'iframe', 'image', 'line',
'linearGradient', 'listener', 'marker', 'mask', 'metadata',
'missing-glyph', 'mpath', 'path', 'pattern', 'polygon', 'polyline',
'prefetch', 'radialGradient', 'rect', 'script', 'set', 'solidColor',
'stop', 'style', 'svg', 'switch', 'symbol', 'tbreak', 'text',
'textArea', 'textPath', 'title', 'tref', 'tspan', 'unknown', 'use',
'video', 'view', 'vkern']);
...
'li', 'link', 'listing', 'main', 'map', 'mark', 'marquee', 'math',
...
'plaintext', 'pre', 'progress', 'q', 'rb', 'rbc', 'rp', 'rt',
